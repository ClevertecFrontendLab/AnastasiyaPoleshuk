...
export const Navigation = () => {
    ...
    const { isList, changeCardsView } = useContext(AppContext);
    ...
    return (
        <div className="nav__wrap">
            <div className="nav__filter-wrap">
                ...
                />
                <button type='button' className="nav__filter" >По рейтингу</button>
                <i className='search' onClick={toggleSearch} data-test-id='button-search-open' />
                <i
                  className={`${isSearchOpen ? 'cross-active' : null}`}
